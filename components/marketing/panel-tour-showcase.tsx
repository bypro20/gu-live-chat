...
const HINTS: Record<string, { tr: string; en: string }> = {
  ...
  '/analytics': { tr: 'Yanıt süresi, dönüşüm ve ekip performans raporları.', en: 'Response time, conversion, and team performance reports.' },
  ...
  '/settings/channels': { tr: 'WhatsApp, e-posta, Instagram ve Telegram bağlayın.', en: 'Connect WhatsApp, email, Instagram, and Telegram.' },
  '/settings/knowledge': { tr: 'SSS makaleleri ve yardım merkezi oluşturun.', en: 'Build FAQ articles and a help center.' },
  '/settings/tickets': { tr: 'Destek biletlerini takip edin ve yönetin.', en: 'Track and manage support tickets.' },
  '/settings/chatbot': { tr: 'AI chatbot kuralları ve otomatik yanıtlar.', en: 'AI chatbot rules and automatic replies.' },
