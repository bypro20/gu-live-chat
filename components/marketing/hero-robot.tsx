...
/** Technoai hero üzerinde yüzen AI sohbet balonu */
export function HeroRobotOverlays() {
  ...
  return (
    <div className="relative hidden lg:block h-full min-h-[420px] pointer-events-none" aria-hidden>
      <div className="technoai-float absolute top-[12%] right-[8%] z-20 max-w-[220px]">
      ...
      <div className="technoai-float-reverse absolute bottom-[18%] right-[12%] z-20 rounded-xl px-3 py-2 shadow-lg border border-cyan-400/30 bg-[#0a1628]/85 backdrop-blur-sm">
      ...
      <div className="technoai-pulse-ring absolute top-[28%] right-[22%] w-20 h-20 rounded-full border border-cyan-400/25" />
    </div>
  )
}
