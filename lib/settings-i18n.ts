...
const tr: SettingsMessages = {
  ...
  widget: {
    ...
    preChatFormDesc: 'Gu Live Chat platform standardı: ziyaretçi adı ve e-posta olmadan sohbet açılmaz. Kapattığınızda anonim mesaj kabul edilir (önerilmez).',
    requireName: 'İsim zorunlu',
    requireNameDesc: 'Sohbet başlamadan önce ad soyad istenir',
    requireEmail: 'E-posta zorunlu',
    requireEmailDesc: 'Sohbet başlamadan önce geçerli e-posta istenir',
...
const en: SettingsMessages = {
  ...
  planUpgrade: {
    features: {
      ...
      aiRag: 'AI Knowledge Training (RAG)',
  ...
  widget: {
    ...
    preChatFormDesc: 'Gu Live Chat platform standard: chat requires name and email. Turning off allows anonymous messages (not recommended).',
    requireName: 'Require name',
    requireNameDesc: 'Visitors must enter their name before chatting',
    requireEmail: 'Require email',
    requireEmailDesc: 'Visitors must enter a valid email before chatting',
