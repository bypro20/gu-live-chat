...
export const marketingEn: MarketingPages = {
  ...
  features: {
    ...
    items: [
      ...
      {
        title: 'Phone and SMS',
        desc: 'Two-way Twilio SMS — inbound messages land in inbox, replies go out as SMS.',
      },
      {
        title: 'Knowledge Base & RAG Training',
        desc: 'Train AI from PDF, URL, and text with semantic search for accurate answers.',
      },
      {
  ...
  integrations: {
    ...
    messaging: [
      ...
      {
        name: 'SMS (Twilio)',
        desc: 'Two-way SMS with Twilio — reply from the unified inbox.',
        status: 'addon',
        href: '/sms-destek',
      },
      {
        name: 'LinkedIn Messaging',
        desc: 'Manage B2B LinkedIn messages in one inbox.',
        status: 'addon',
        href: '/linkedin-destek',
      },
      {
        name: 'Voice AI Assistant',
        desc: 'Browser voice AI powered by knowledge base and web search.',
        status: 'active',
        href: '/sesli-ai',
      },
      {
  ...
  ai: {
    ...
    subtitle:
      'RAG training, voice AI, inbox copilot, web search, and smart agent routing — the Gu Live Chat AI platform delivers 24/7 support.',
    howTitle: 'How to get started',
    howSubtitle: 'Launch your AI platform in 5 steps',
    steps: [
      'Train knowledge base with PDF, URL, or text (RAG)',
      'Enable AI assistant, web search, and inbox copilot',
      'Connect channels (WhatsApp, SMS, LinkedIn) and chatbot flows',
      'Add voice AI embed link to your site (optional)',
      'Track bot replies, sentiment, and AI metrics in analytics',
    ],
    stats: ['PDF & URL RAG training', 'Voice AI + inbox copilot', 'Smart agent routing'],
    ctaTitle: 'Try the AI platform',
    ctaSubtitle: 'AI features are included in Professional; lower plans can unlock via add-ons.',
    capabilities: [
      { title: 'RAG knowledge training', desc: 'Upload PDF, URL, and text; semantic search grounds AI in your content.' },
      { title: 'Voice AI assistant', desc: 'Browser voice support — Web Speech + knowledge base + web search.' },
      { title: 'Inbox AI Copilot', desc: 'One-click reply suggestions, shorten, grammar fix, and translate for agents.' },
      { title: 'Web search & vision', desc: 'DuckDuckGo context for current topics; Gemini Vision reads visitor images.' },
      { title: 'Smart model routing', desc: 'Economy models for simple questions, stronger models for complex ones.' },
      { title: 'Smart agent handoff', desc: 'Bot routes complex chats to the least-loaded online agent with summary.' },
      { title: 'Sentiment analysis', desc: 'Negative messages are flagged; sentiment breakdown in analytics.' },
      { title: 'AI analytics', desc: 'Bot reply count, handoffs, RAG chunks, and top visitor messages.' },
    ],
  },
  contact: {
    badge: 'Contact',
  ...
  seoLandings: {
    ...
    sesliAi: {
      ...
      h1: 'Voice AI customer support in the browser',
      subtitle:
        'Gu Live Chat voice AI uses Web Speech in the browser with RAG knowledge, web search, and smart model routing.',
      cta: { label: 'Try Voice AI', href: '/register' },
      benefits: [
        { title: 'Web Speech', desc: 'Talk via microphone; AI responds with speech — no app install.' },
        { title: 'RAG powered', desc: 'PDF and URL training flows into voice answers.' },
        { title: 'Embed link', desc: 'Add /voice/SITE_ID to your site as iframe or new tab.' },
      ],
      sections: [{ title: 'Who is it for?', paragraphs: ['Teams that want voice support without a phone line.'] }],
      faqs: [{ q: 'Do I need a phone line?', a: 'No. Browser Web Speech API is used with microphone permission.' }],
      relatedLinks: [{ label: 'AI Platform', href: '/ai' }, { label: 'Pricing', href: '/pricing' }],
    },
    linkedinDestek: {
      badge: 'LinkedIn Messaging',
      h1: 'Manage LinkedIn messages in one inbox',
      subtitle: 'B2B customers message on LinkedIn; your team replies from Gu Live Chat with AI auto-reply and handoff.',
      cta: { label: 'Enable LinkedIn Channel', href: '/register' },
      benefits: [
        { title: 'Unified inbox', desc: 'LinkedIn with widget, WhatsApp, and email in one place.' },
        { title: 'AI replies', desc: 'AI handles repetitive B2B questions; agents get handoff summaries.' },
      ],
      sections: [{ title: 'Setup', paragraphs: ['Buy LinkedIn channel add-on, configure token under Settings > Channels.'] }],
      faqs: [{ q: 'LinkedIn API required?', a: 'Yes — LinkedIn Developer app and valid access token.' }],
      relatedLinks: [{ label: 'Integrations', href: '/integrations' }],
    },
    smsDestek: {
      badge: 'Twilio SMS',
      h1: 'Two-way SMS customer support',
      subtitle: 'Twilio SMS lands in inbox; agent replies go out as SMS. AI auto-reply supported.',
      cta: { label: 'Start SMS Channel', href: '/register' },
      benefits: [
        { title: 'Two-way SMS', desc: 'Customers text in; you reply from the panel with full history.' },
        { title: 'Twilio', desc: 'Quick setup with Account SID, Auth Token, and phone number.' },
      ],
      sections: [{ title: 'Webhook', paragraphs: ['Configure /api/webhooks/sms?websiteId=YOUR_ID in Twilio Messaging.'] }],
      faqs: [{ q: 'Twilio account required?', a: 'Yes, with an SMS-enabled phone number.' }],
      relatedLinks: [{ label: 'Integrations', href: '/integrations' }],
    },
  },
  legal: {
