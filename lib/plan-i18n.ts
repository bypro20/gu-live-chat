...
const catalogTr: Record<PlanId, PlanCatalogEntry> = {
  ...
  STARTER: {
    ...
    features: [
      ...
      'Canlı Çeviri Pro eklentisi ile 50+ dil (₺99/ay)',
    ],
  },
  PRO: {
    name: 'Profesyonel',
    ...
    features: [
      ...
      '50+ dil çift yönlü otomatik çeviri — dünya geneli sohbet',
...
const catalogEn: Record<PlanId, PlanCatalogEntry> = {
  ...
  STARTER: {
    ...
    features: [
      ...
      'Live Translate Pro add-on: 50+ languages (₺99/mo)',
    ],
  },
  PRO: {
    name: 'Professional',
    ...
    features: [
      ...
      '50+ language two-way auto-translate — chat worldwide',
