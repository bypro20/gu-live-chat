  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Organik Otomasyon',
        description: 'AI strateji ve içerik takvimi',
        icon: 'marketing',
        keywords: ['organic', 'blog', 'instagram', 'linkedin', 'içerik'],
        match: (p) => p.startsWith('/admin/marketing/organic'),
      },
    ],
  },
  {
