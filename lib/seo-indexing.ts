...
/** Google/Bing indeksleme için öncelikli sayfalar */
...
/** Bing'e sitemap ping — doğrulama gerektirmez */
...
/** IndexNow — Bing, Yandex ve destekleyen motorlara anında bildirim */
export async function submitIndexNow(urls: string[] = PRIORITY_URLS): Promise<IndexingResult['indexNow']> {
  try {
    ...
    // IndexNow returns 200, 202 accepted
