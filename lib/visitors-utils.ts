...
export function getAccent(theme: VisitorTheme) {
  if (theme === 'admin') {
    return {
      avatar: 'from-red-600 to-red-500 shadow-red-500/25',
      ...
      button: 'admin-screen-watch-btn bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 shadow-lg shadow-red-500/25',
