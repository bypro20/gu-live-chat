...
export const homeEn: HomeMessages = {
  ...
  ai: {
    ...
    steps: [
      { title: 'RAG training with PDF & URL', desc: 'Semantic knowledge base — AI answers from your content, not guesses.' },
      { title: 'Copilot & auto-reply', desc: 'Inbox suggestions and 24/7 AI on widget and channels.' },
      { title: 'Voice AI & channels', desc: 'Browser voice assistant; WhatsApp, SMS, LinkedIn in one inbox.' },
      { title: 'Smart handoff', desc: 'Complex chats route to the best agent with summary.' },
    ],
    cta: 'Explore the AI platform',
  },
  aiPlatform: {
    label: 'AI Platform',
    title: 'End-to-end AI support stack',
    desc: 'RAG training, voice AI, inbox copilot, web search, sentiment, and smart model routing — in one dashboard.',
    items: [
      { title: 'RAG knowledge training', desc: 'PDF, URL, and text semantic search.', href: '/ai' },
      { title: 'Voice AI', desc: 'Browser voice support via Web Speech.', href: '/sesli-ai' },
      { title: 'Inbox Copilot', desc: 'Reply suggestions and editing for agents.', href: '/ai' },
      { title: 'LinkedIn inbox', desc: 'B2B messages in one unified inbox.', href: '/linkedin-destek' },
      { title: 'Twilio SMS', desc: 'Two-way SMS from the inbox.', href: '/sms-destek' },
      { title: 'AI analytics', desc: 'Bot replies, sentiment, and top questions.', href: '/ai' },
    ],
    cta: 'All AI features',
  },
  translate: {
  ...
  inbox: {
    ...
    channels: ['Widget', 'Email', 'WhatsApp', 'SMS', 'LinkedIn', 'Messenger', 'Instagram', 'Telegram'],
    samples: [
