...
export const homeTr: HomeMessages = {
  ...
  ai: {
    ...
    steps: [
      { title: 'PDF & URL ile RAG eğitimi', desc: 'Semantik bilgi bankası — AI uydurma değil, sizin içeriğinizle yanıtlar.' },
      { title: 'Copilot & otomatik yanıt', desc: 'Inbox önerileri ve 7/24 widget/kanal AI yanıtı.' },
      { title: 'Sesli AI & kanallar', desc: 'Tarayıcıda sesli asistan; WhatsApp, SMS, LinkedIn tek inbox.' },
      { title: 'Akıllı devretme', desc: 'Karmaşık talepler en uygun temsilciye özetle aktarılır.' },
    ],
    cta: 'AI platformunu keşfet',
  },
  aiPlatform: {
    label: 'AI Platformu',
    title: 'Supsis tarzı uçtan uca AI destek',
    desc: 'RAG eğitimi, sesli asistan, inbox copilot, web araması, duygu analizi ve akıllı model yönlendirme — tek panelde.',
    items: [
      { title: 'RAG bilgi eğitimi', desc: 'PDF, URL ve metin ile semantik arama.', href: '/ai' },
      { title: 'Sesli AI', desc: 'Web Speech ile tarayıcıda konuşmalı destek.', href: '/sesli-ai' },
      { title: 'Inbox Copilot', desc: 'Temsilciye yanıt önerisi ve düzenleme.', href: '/ai' },
      { title: 'LinkedIn inbox', desc: 'B2B mesajları tek gelen kutusunda.', href: '/linkedin-destek' },
      { title: 'Twilio SMS', desc: 'İki yönlü SMS — gelen kutusunda yanıt.', href: '/sms-destek' },
      { title: 'AI analitik', desc: 'Bot yanıtları, duygu ve sık sorular.', href: '/ai' },
    ],
    cta: 'Tüm AI özellikleri',
  },
  translate: {
    label: 'Canlı Çeviri',
  ...
  inbox: {
    ...
    channels: ['Widget', 'E-posta', 'WhatsApp', 'SMS', 'LinkedIn', 'Messenger', 'Instagram', 'Telegram'],
    samples: [
