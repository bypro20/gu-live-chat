...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('[iyzico subscription] GET error:', error)
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('[iyzico subscription] POST error:', error)
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    console.error('[iyzico subscription] PATCH error:', error)
