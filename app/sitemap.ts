...
const STATIC_ROUTES: Array<{
  ...
  { path: '/sesli-ai', priority: 0.92, changeFrequency: 'weekly' },
  { path: '/linkedin-destek', priority: 0.9, changeFrequency: 'weekly' },
  { path: '/sms-destek', priority: 0.9, changeFrequency: 'weekly' },
