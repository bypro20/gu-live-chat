...
export default function AddonsPage() {
  ...
  useEffect(() => {
    ...
    const scrollEl = document.querySelector('.app-content-scroll')
    const prevOverflow = scrollEl instanceof HTMLElement ? scrollEl.style.overflow : ''
    if (scrollEl instanceof HTMLElement) scrollEl.style.overflow = 'hidden'
    return () => {
      if (scrollEl instanceof HTMLElement) scrollEl.style.overflow = prevOverflow
    }
  }, [modalAddon])
        ...
        ? createPortal(
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
              <div
                ...
                aria-hidden
              />
              <div className="relative w-full max-w-md animate-in-scale" role="dialog" aria-modal="true">
