...
export default function WidgetSettingsPage() {
  ...
  const handleSave = async (payload: ReturnType<typeof widgetConfigToPayload>) => {
    if (!activeWebsite) throw new Error('Aktif web sitesi bulunamadı')
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Chat widget görünümünü ve davranışını özelleştirin
        </p>
      </div>
      ...
      <WidgetSettingsPanel
        ...
        subtitle={
          activeWebsite
            ? `Değişiklikler ${activeWebsite.name} sitesinin widget'ına uygulanır.`
            : undefined
        }
      />
    </div>
