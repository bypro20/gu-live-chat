...
function AdminLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  if (loading || !admin) {
    return (
      <div className="h-screen flex items-center justify-center admin-shell admin-shell-v2 admin-text" data-admin-theme="dark" style={{ background: 'var(--admin-bg, #110808)' }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {inboxUnread > 0 && (
                <span className="absolute top-0.5 right-0.5 min-w-[1rem] h-4 px-0.5 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">
